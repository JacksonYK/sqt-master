 ...
 * @property {Tetris.Tetromino} held_tetromino The tetromino you are holding.
 * @property {boolean} can_hold A boolean that determines if holding is allowed.
 */
...
/**
 * The width of a tetris field that display the next tetromino.
 * @constant
 * @memberof Tetris
 * @default
 */
 Tetris.next_tetro_field_width = 10;


 /**
 * The height of a tetris field that display the next tetromino.
 * @constant
 * @memberof Tetris
 * @default
 */
  Tetris.next_tetro_field_height = 4;
...
/**
 * This function takes a game, and returns a new game with the current tetromino held.
 * @function
 * @memberof Tetris
 * @param {Tetris.Game} game
 * @returns {Tetris.Game}
...
Tetris.hold =  function (game) {
	if(game.can_hold){
		const current_tetromino = game.held_tetromino ? game.held_tetromino : game.next_tetromino;
		const res = game.bag();
		const next_tetromino = game.held_tetromino ? game.next_tetromino : res[0];
		const bag = game.held_tetromino ? game.bag : res[1];
		return {
		    "bag": bag,
		    "current_tetromino": current_tetromino,
		    "field": game.field,
